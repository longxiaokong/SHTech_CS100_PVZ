...
public:
  ...
  Zombie (pGameWorld, ZombieType type, int, int initial_X = WINDOW_WIDTH - 1,
  ...
  void
  setIsEating (bool flag)
  {
    m_is_eating = flag;
  }

  int
  getOriginalVelocity () const
  {
    return m_original_velocity;
  }
  void
  setOriginalVelocity (int v)
  {
    m_original_velocity = v;
  }
