...
MovingObject::MovingObject (pGameWorld pWorld, ImageID img, int initial_x,
                            int initial_y, LayerID layer, int width,
                            int height, AnimID animID, int velocity_x = 0,
                            int velocity_y = 0, int acceleration_x = 0,
                            int acceleration_y = 0)
    : GameObject (pWorld, img, initial_x, initial_y, layer, width, height,
                  animID),
