...
class BucketHeadZombie : public Zombie, public std::enable_shared_from_this<BucketHeadZombie> {
public:
  using std::enable_shared_from_this<BucketHeadZombie>::shared_from_this;
  BucketHeadZombie(pGameWorld, int, int initial_X=WINDOW_WIDTH - 1, int velocity_X=ZOMBIE_VELOCITY_REGULAR);
