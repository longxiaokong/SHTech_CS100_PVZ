...
public:
  ...
  virtual bool isDead() override {return m_is_dead;}
  virtual void UpdateMoveStatus() = 0;
  virtual void UpdateArbitrary() override;
  void StartLifetimeTimer() {m_lifetime_timer.StartTimer();}
  bool isLifetimeTiming() {return m_lifetime_timer.isTiming();}
  virtual ~Sun() = default;
private:
